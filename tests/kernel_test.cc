...
TEST(kernel_test, can_handle_empty_action_on_data) {
    ...
    const boost::json::object _data = {{"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}};
...
TEST(kernel_test, can_handle_wrong_action_primitive_on_data) {
    ...
    const boost::json::object _data = {{"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}, {"action", 7}};
...
TEST(kernel_test, can_handle_non_implemented_action) {
    ...
    const boost::json::object _data = {{"action", "invalid"},{"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}};
...
TEST(kernel_test, can_handle_pong) {
    ...
    const boost::json::object _data = {{"action", "ping"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}};
...
TEST(kernel_test, can_handle_whoami) {
    ...
    const boost::json::object _data = {{"action", "whoami"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}};
...
TEST(kernel_test, can_handle_empty_params_client_id_on_subscriptions) {
    const auto _state = std::make_shared<aewt::state>();
    ...
    const boost::json::object _data = {{"action", "subscribe"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}, {"params", {{"channel", "welcome"}}}};
...
TEST(kernel_test, can_handle_wrong_params_client_id_primivite_on_subscriptions) {
    const auto _state = std::make_shared<aewt::state>();
    ...
    const boost::json::object _data = {{"action", "subscribe"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}, {"params", {{"channel", "welcome"}, {"client_id", 1}}}};
...
TEST(kernel_test, can_handle_subscribe) {
    ...
    const boost::json::object _data = {{"action", "subscribe"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}, {"params", {{"channel", "welcome"}, {"client_id", "bda9f293-2102-4a5b-9f5d-2f7cb52fab89"}}}};
...
TEST(kernel_test, can_handle_no_effect_on_subscribe) {
    const auto _state = std::make_shared<aewt::state>();
    ...
    const boost::json::object _data = {{"action", "subscribe"}, {"transaction_id", "ce287866-fe31-4b30-a242-2bbe7fb73940"}, {"params", {{"channel", "welcome"}, {"client_id", "bda9f293-2102-4a5b-9f5d-2f7cb52fab89"}}}};
...
TEST(kernel_test, can_handle_unsubscribe) {
    const auto _state = std::make_shared<aewt::state>();
    ...
    const boost::json::object _data = {{"action", "unsubscribe"}, {"transaction_id", "78dbde63-817c-46bc-a470-71d066eb3eed"}, {"params", {{"channel", "welcome"}, {"client_id", "bda9f293-2102-4a5b-9f5d-2f7cb52fab89"}}}};
...
TEST(kernel_test, can_handle_no_effect_on_unsubscribe) {
    const auto _state = std::make_shared<aewt::state>();
    ...
    const boost::json::object _data = {{"action", "unsubscribe"}, {"transaction_id", "ce287866-fe31-4b30-a242-2bbe7fb73940"}, {"params", {{"channel", "welcome"}, {"client_id", "bda9f293-2102-4a5b-9f5d-2f7cb52fab89"}}}};
