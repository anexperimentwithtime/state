...
TEST(handlers_client_handler_test, can_handle) {
    ...
    _state->subscribe(_state->get_id(), _remote_client->get_id(), "a");
    _state->subscribe(_state->get_id(), _remote_client->get_id(), "b");
    _state->subscribe(_state->get_id(), _remote_client->get_id(), "c");
    ...
    ASSERT_EQ(_response->get_data().at("data").as_object().at("session_id").as_string(),
              to_string(_remote_session->get_id()));
