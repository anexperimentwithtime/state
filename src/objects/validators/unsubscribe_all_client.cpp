...
#include <aewt/validators/unsubscribe_all_client.hpp>

#include <aewt/response.hpp>
#include <aewt/validator.hpp>

namespace aewt::validators {
    bool unsubscribe_all_client(const boost::uuids::uuid transaction_id,
                                const std::shared_ptr<response> &response, const boost::json::object &data) {
